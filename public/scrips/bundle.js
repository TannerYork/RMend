...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _firestore_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./firestore.js */ \"./src/scrips/firestore.js\");\n/* harmony import */ var _base_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./base.js */ \"./src/scrips/base.js\");\n/* harmony import */ var _models_Report_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/Report.js */ \"./src/scrips/models/Report.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nconsole.log('Connected to app.js');\n\n\n\nvar elements = new _base_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\n/**\n* App Inisilization/Controll.\n*/\n// Registures service worker \n\nif ('serviceWorker' in navigator) {\n  navigator.serviceWorker.register('/service-worker.js').then(function (registration) {\n    // Registration was successful\n    console.log('ServiceWorker registration successful with scope: ', registration.scope);\n  }, function (err) {\n    // registration failed :(\n    console.log('ServiceWorker registration failed: ', err);\n  });\n}\n\nfunction checkBeforeInstallPromt(event) {\n  console.log(\"Download is Avalible\");\n  event.preventDefault();\n  elements.deferredPrompt = event;\n  elements.downloadBtn.addEventListener(\"click\", elements.addToHomeScreen.bind(elements));\n}\n\nwindow.addEventListener('beforeinstallprompt', checkBeforeInstallPromt); // Checks that Firebase has been imported.\n\nif (_firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"checkSetup\"]()) {\n  //if (firebase.auth().currentUser) {/* Do Nothing */} else {elements.loadLoginPage();}\n  // Allow User to sign in vis sidebar or auth UI\n  if (navigator.onLine) {\n    /**\n     * Admin Event Listeners (These are currently placed here because on mobile they do not work anywhere else.\n     */\n    // Checks for sidebar admin buttons interaction and loads the correct page\n    var checkForListChange =\n    /*#__PURE__*/\n    function () {\n      var _ref = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee(event) {\n        var btn, userIDToken;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                btn = event.target.closest('.sidebar__list-item');\n\n                if (!(btn && btn.textContent == 'View Reports')) {\n                  _context.next = 8;\n                  break;\n                }\n\n                _context.next = 4;\n                return firebase.auth().currentUser.getIdTokenResult(true);\n\n              case 4:\n                userIDToken = _context.sent;\n\n                if (userIDToken.claims && userIDToken.claims.moderator == true) {\n                  console.log(\"moderator\");\n                  elements.renderModeratorReportsList();\n                } else {\n                  console.log(\"Verified User\");\n                  elements.renderVerifiedUserReportsList();\n                }\n\n                _context.next = 9;\n                break;\n\n              case 8:\n                if (btn && btn.textContent == 'Users') {\n                  elements.renderUsersList();\n                } else if (btn && btn.textContent == 'Pending Users') {\n                  elements.renderPendingUsersList();\n                } else if (btn && btn.textContent == 'Report a Problem') {\n                  elements.renderReportView();\n                  elements.initilizeReportDataForm(_firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"saveReport\"]);\n                } else if (btn && btn.textContent == 'Notifications') {\n                  elements.renderSettingsView();\n                  elements.initilizeSettingsForm(_firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"toggleNotificationsOn\"], _firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"toggleNotificationsOff\"], _firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"saveMessagingDeviceToken\"]);\n                }\n\n              case 9:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee);\n      }));\n\n      return function checkForListChange(_x) {\n        return _ref.apply(this, arguments);\n      };\n    }();\n\n    // Checks for admin settings page interaction and submits changes if needed\n    var checkForSettingsInteraction = function checkForSettingsInteraction(event) {\n      var input = event.target.closest('.js-notiffication-input');\n\n      if (input && input.value == true) {}\n    };\n\n    // Checks for admin list items interaction and acts as needed\n    var checkForItemInteraction = function checkForItemInteraction(event) {\n      // If list item is a pending user, verify user\n      var pendingUser = event.target.closest('.js-pendingUsers-list__item');\n      if (pendingUser && pendingUser.dataset.email) elements.toggleOptions(pendingUser.querySelector(\".options\")); // If list item is a user, unverify the user\n\n      var user = event.target.closest('.js-users-list__item');\n      if (user && user.dataset.email) elements.toggleOptions(user.querySelector(\".options\")); // If list item is a reports delet button, remove the report from firebase\n\n      var reportItemButtonDelete = event.target;\n\n      if (reportItemButtonDelete.classList.contains('.js-report-item-delete') && reportItemButtonDelete.parentElement.dataset.id) {\n        if (confirm(\"Are your sure you want to delete this report? You can not retrieve it once deleted.\")) {\n          _firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"removeReportListItem\"](reportItemButtonDelete.parentElement.dataset.id);\n        }\n      } // If list item is a reports delet button, remove the report from firebase\n\n\n      var reportItemButtonPrint = event.target;\n\n      if (reportItemButtonPrint.classList.contains('.js-report-item-print') && reportItemButtonPrint.parentElement.dataset.id) {\n        _firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"getReport\"](reportItemButtonPrint.parentElement.dataset.id).then(function (data) {\n          if (data !== false) {\n            var report = new _models_Report_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"](data, data.timestamp);\n            elements.reviealReportPrintPage(report);\n          }\n        });\n      } // If list item is a reports delet button, remove the report from firebase\n\n\n      var reportItemButtonPriority = event.target.closest('.checkbox');\n\n      if (reportItemButtonPriority && reportItemButtonPriority.parentElement.parentElement.dataset.id) {\n        var id = reportItemButtonPriority.parentElement.parentElement.dataset.id;\n\n        if (reportItemButtonPriority.checked == true) {\n          _firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"updatePriority\"](id, true);\n          elements.toggleBorder(id);\n        } else {\n          _firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"updatePriority\"](id, false);\n          elements.toggleBorder(id);\n        }\n      } // If item is the report itsself, show the details of the report.\n\n\n      var reportItem = event.target;\n\n      if (reportItem.classList.contains('.js-report-item')) {\n        elements.toggleDetials(reportItem);\n      }\n    };\n\n    // Checks if user list item as user interaction and act as needed\n    var checkForUserItemInteraction = function checkForUserItemInteraction(event) {\n      var target = event.target;\n\n      if (target.textContent == 'Moderate') {\n        // If list item is a pending user, verify user\n        var email = target.parentElement.parentElement.dataset.email;\n        _firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"grantModeratorRole\"](email);\n      } else if (target.textContent == 'Verifiy') {\n        // If list item is a user, unverify the user\n        var _email = target.parentElement.parentElement.dataset.email;\n        _firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"validateUser\"](_email);\n      } else if (target.textContent == 'Unverify') {\n        // If list item is a reports delet button, remove the report from firebase\n        var _email2 = target.parentElement.parentElement.dataset.email;\n        _firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"unvalidateUser\"](_email2);\n      }\n    };\n\n    _firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"setupAuthUi\"]();\n    elements.sidebarLogin.addEventListener('click', _firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"signIn\"]);\n    elements.sidebarLogout.addEventListener('click', _firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"signOut\"]);\n    elements.sidebar.addEventListener('click', checkForListChange);\n    elements.settingsPage.addEventListener('click', checkForSettingsInteraction);\n    elements.reportsList.addEventListener('click', checkForItemInteraction);\n    elements.reportsList.addEventListener('click', checkForUserItemInteraction);\n  } else {\n    // Prompt User that they are offline and therfore can't perform firebase functions\n    elements.showOfflineIndicator();\n  }\n\n  elements.sidebarHamburber.addEventListener('click', elements.toggleSidebar.bind(elements));\n  elements.sidebarList.addEventListener('click', function (event) {\n    var sidebarItem = event.target.closest('.sidebar__list-item');\n    if (sidebarItem) elements.toggleSidebar();\n  });\n  firebase.auth().onAuthStateChanged(\n  /*#__PURE__*/\n  function () {\n    var _ref2 = _asyncToGenerator(\n    /*#__PURE__*/\n    regeneratorRuntime.mark(function _callee2(user) {\n      var userName, imgUrl, userIDToken, userStatus, reportForm;\n      return regeneratorRuntime.wrap(function _callee2$(_context2) {\n        while (1) {\n          switch (_context2.prev = _context2.next) {\n            case 0:\n              if (!user) {\n                _context2.next = 17;\n                break;\n              }\n\n              // User is signed in \n              console.log('User is signed in');\n              userName = _firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"getUserName\"]();\n              imgUrl = _firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"getProfilePicUrl\"]();\n              elements.displayCurrentUserInfo(userName, imgUrl); // Check users allowNotifications property\n\n              firebase.functions().httpsCallable('checkAllowNotifications')().then(function (results) {\n                if (results.data.error) {\n                  console.log(results.data.error);\n                } else {\n                  if (results.data.result == true) {\n                    // If user has previously set allowNotifications to true save device token for messaging\n                    _firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"saveMessagingDeviceToken\"]();\n                    _firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"updateMessagingDeviceToken\"]();\n                  }\n                }\n              }); // Load reports page and get users authToken\n\n              _context2.next = 8;\n              return elements.loadReportsPage();\n\n            case 8:\n              _context2.next = 10;\n              return firebase.auth().currentUser.getIdTokenResult(true);\n\n            case 10:\n              userIDToken = _context2.sent;\n              _context2.next = 13;\n              return elements.loadReportsPageInnerHTML(userIDToken);\n\n            case 13:\n              userStatus = _context2.sent;\n\n              if (userStatus == 'moderator') {\n                console.log(\"Moderatore\");\n                elements.renderModeratorReportsList();\n                /**\n                 * Currently all admin listeners are stated above due to the fact that on \n                 * mobile devices function inside double nested starting if staments do not \n                 * run at all. If you know a solution, please contact Tanner W. York.\n                */\n              } else if (userStatus == 'verifiedUser') {\n                // If reportform DOM is loaded, initilized the report form listener\n                reportForm = document.querySelector('.js-issue-form');\n                if (reportForm) elements.initilizeReportDataForm(_firestore_js__WEBPACK_IMPORTED_MODULE_0__[\"saveReport\"]);\n              } else if (userStatus == 'user') {\n                elements.renderUserView();\n              }\n\n              _context2.next = 19;\n              break;\n\n            case 17:\n              // User is signed out\n              console.log('User is signed out'); // Return user to login page\n\n              elements.loadLoginPage();\n\n            case 19:\n            case \"end\":\n              return _context2.stop();\n          }\n        }\n      }, _callee2);\n    }));\n\n    return function (_x2) {\n      return _ref2.apply(this, arguments);\n    };\n  }());\n} else {\n  console.log(\"Firebase is not setup\");\n}\n\n//# sourceURL=webpack:///./src/scrips/app.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Elements; });\n/* harmony import */ var _models_Report_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/Report.js */ \"./src/scrips/models/Report.js\");\n/* harmony import */ var _firestore_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./firestore.js */ \"./src/scrips/firestore.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\n\nvar Elements =\n/*#__PURE__*/\nfunction () {\n  function Elements() {\n    _classCallCheck(this, Elements);\n\n    //Main Elements and HTML\n    this.page = document.querySelector('.page'), this.downloadBtn = document.querySelector('.download-btn'), //Sidebar Elements\n    this.sidebar = document.querySelector('.sidebar'), this.sidebarList = document.querySelector('.sidebar__list'), this.sidebarHamburber = document.querySelector('.sidebar__hamburger'), this.sidebarCurrentUser = document.querySelector('.current-user__info'), this.sidebarCurrentUserName = document.querySelector('.current-user__name'), this.sidebarCurrentUserImg = document.querySelector('.current-user__img'), this.sidebarLogin = document.querySelector('.sidebar__login'), this.sidebarLogout = document.querySelector('.sidebar__logout'), this.sidebarPendingUsers = document.querySelector('.pendingUsers'), this.sidebarUsers = document.querySelector('.users'), this.sidebarReports = document.querySelector('.reports'), this.sidebarReport = document.querySelector('.report-issue'), this.sidebarSettings = document.querySelector('.user-settings'), // Login Page Elements\n    this.loginPage = document.querySelector('.login-page');\n    this.mainLoginButtons = document.querySelector('.main-buttons'); // User Page Elements\n\n    this.userPage = document.querySelector('.main-container');\n    this.settingsPage = document.querySelector('.settings-page');\n    this.settingsForm = document.querySelector('.js-settings-form'); // Moderated User Elements\n\n    this.adminPage = document.querySelector('.moderated-user-page');\n    this.reportsList = document.querySelector('.reports-list'); // Verified User Elements\n\n    this.verifiedUserPage = document.querySelector('.verified-user-page');\n    this.reportForm = document.querySelector('.js-issue-form');\n    this.reportImageDisplay = document.querySelector('.js-form-img-display');\n    this.reportImage = document.querySelector('.js-issue-photo');\n    this.reportRoadName = document.querySelector('.js-issue-roadName');\n    this.reportDetails = document.querySelector('.js-issue-details');\n    this.reportNearestStreet = document.querySelector('.js-issue-nearestStreet');\n    this.reportMagistrialDistrict = document.querySelector('.js-issue-magistrialDistrict');\n    this.reportPriorityTrue = document.querySelector('.js-issue-priority-input-true');\n    this.reportPriorityFalse = document.querySelector('.js-issue-priority-input-false'); // Unverifyed User Elements\n\n    this.unverifedUserPage = document.querySelector('.unverifed-user-page'); // Misc Elements\n\n    this.reportPrintPage = document.querySelector('.js-report-print');\n    this.reportPrintImg = document.querySelector('.js-report-print__img');\n    this.reportPrintSender = document.querySelector('.js-report-print__sender');\n    this.reportPrintMagistrialDistrict = document.querySelector('.js-report-print__MD');\n    this.reportPrintRoadName = document.querySelector('.js-report-print__road-name');\n    this.reportPrintNearestStreet = document.querySelector('.js-report-print__nearest-street');\n    this.reportPrintDate = document.querySelector('.js-report-print__date'); // Furebase listeners for updating UI\n\n    this.listeners = [], // Client App Elements and Variables\n    this.deferredPrompt = null;\n  }\n  /**\n   *  Main DOM Functions\n   */\n  // Load the login page and remove reportsPage elements\n\n\n  _createClass(Elements, [{\n    key: \"loadLoginPage\",\n    value: function loadLoginPage() {\n      this.listeners.forEach(function (listener) {\n        return listener();\n      });\n      this.mainLoginButtons.style.display = \"flex\";\n      this.loginPage.style.display = 'flex';\n      this.userPage.style.display = 'none';\n      this.sidebarCurrentUser.style.display = 'none';\n      this.sidebarReports.style.display = 'none';\n      this.sidebarReport.style.display = 'none';\n      this.sidebarSettings.style.display = 'none';\n      this.sidebarUsers.style.display = 'none';\n      this.sidebarPendingUsers.style.display = 'none';\n      this.sidebarLogout.style.display = 'none';\n      this.sidebarLogin.style.display = 'flex';\n    } // Loads the main elements for the reports/user page and removes the loginPage elements\n\n  }, {\n    key: \"loadReportsPage\",\n    value: function loadReportsPage() {\n      this.sidebarLogin.style.display = 'none';\n      this.sidebarLogout.style.display = 'flex';\n      this.mainLoginButtons.style.display = \"none\";\n      this.loginPage.style.display = \"none\";\n      this.userPage.style.display = 'flex';\n    } // Loads the user specific elements for the reports page\n\n  }, {\n    key: \"loadReportsPageInnerHTML\",\n    value: function () {\n      var _loadReportsPageInnerHTML = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee(idTokenResult) {\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                if (!(idTokenResult.claims && idTokenResult.claims.moderator == true)) {\n                  _context.next = 6;\n                  break;\n                }\n\n                _context.next = 3;\n                return this.loadAdminHTML();\n\n              case 3:\n                return _context.abrupt(\"return\", 'moderator');\n\n              case 6:\n                if (!(idTokenResult.claims && idTokenResult.claims.verified == true)) {\n                  _context.next = 12;\n                  break;\n                }\n\n                _context.next = 9;\n                return this.renderReportView();\n\n              case 9:\n                return _context.abrupt(\"return\", 'verifiedUser');\n\n              case 12:\n                // Load Unvalidated User HTML\n                this.listeners.forEach(function (listener) {\n                  return listener();\n                });\n                _context.next = 15;\n                return this.renderUserView();\n\n              case 15:\n                return _context.abrupt(\"return\", 'user');\n\n              case 16:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, this);\n      }));\n\n      function loadReportsPageInnerHTML(_x) {\n        return _loadReportsPageInnerHTML.apply(this, arguments);\n      }\n\n      return loadReportsPageInnerHTML;\n    }()\n  }, {\n    key: \"displayCurrentUserInfo\",\n    value: function displayCurrentUserInfo(name, imgUrl) {\n      this.sidebarCurrentUser.style.display = 'flex';\n      this.sidebarCurrentUserName.textContent = name;\n      this.sidebarCurrentUserImg.style.backgroundImage = \"url(\".concat(imgUrl, \")\");\n    }\n  }, {\n    key: \"toggleSidebar\",\n    value: function toggleSidebar() {\n      this.sidebar.classList.toggle('is-visible');\n    }\n  }, {\n    key: \"toggleOptions\",\n    value: function toggleOptions(element) {\n      element.classList.toggle('visible');\n    }\n  }, {\n    key: \"toggleDetials\",\n    value: function toggleDetials(element) {\n      element.classList.toggle('visible');\n    }\n    /**\n     * Unverified User DOM Functions\n     */\n    // Render unverified user page\n\n  }, {\n    key: \"renderUserView\",\n    value: function renderUserView() {\n      this.listeners.forEach(function (listener) {\n        return listener();\n      });\n      this.unverifedUserPage.style.display = 'flex';\n    }\n    /**\n     * Verified User DOM Functions\n     */\n    // Render the report form\n\n  }, {\n    key: \"renderReportView\",\n    value: function renderReportView() {\n      this.listeners.forEach(function (listener) {\n        return listener();\n      });\n      this.adminPage.style.display = 'none';\n      this.settingsPage.style.display = 'none';\n      this.verifiedUserPage.style.display = 'flex';\n      this.sidebarReports.style.display = 'flex';\n      this.sidebarReport.style.display = 'flex';\n    } // Initilize report form\n\n  }, {\n    key: \"initilizeReportDataForm\",\n    value: function () {\n      var _initilizeReportDataForm = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee4(reportUploadFunction) {\n        var _this = this;\n\n        var imageDisplay;\n        return regeneratorRuntime.wrap(function _callee4$(_context4) {\n          while (1) {\n            switch (_context4.prev = _context4.next) {\n              case 0:\n                if (this.reportForm) {\n                  // If the report form elements initilized properly, listen for user to submit the report\n                  imageDisplay = document.querySelector('.js-form-img-display'); //Diaplays the selected image wuth the correct orientation to be turned into a blob when submited\n\n                  this.reportImage.onchange = function (e) {\n                    loadImage(e.target.files[0], function (img) {\n                      if (imageDisplay.hasChildNodes()) {\n                        imageDisplay.removeChild(imageDisplay.childNodes[0]);\n                      }\n\n                      imageDisplay.appendChild(img);\n                    }, {\n                      maxWidth: 300,\n                      orientation: true,\n                      canvas: true // Options\n\n                    });\n                  };\n\n                  this.reportForm.addEventListener('submit',\n                  /*#__PURE__*/\n                  function () {\n                    var _ref = _asyncToGenerator(\n                    /*#__PURE__*/\n                    regeneratorRuntime.mark(function _callee3(event) {\n                      var data, canvas;\n                      return regeneratorRuntime.wrap(function _callee3$(_context3) {\n                        while (1) {\n                          switch (_context3.prev = _context3.next) {\n                            case 0:\n                              console.log('Submited');\n                              event.preventDefault();\n                              event.stopPropagation();\n                              data = {}; // Convert image to blob from canvas\n\n                              if (!(_this.reportImage.files.length > 0)) {\n                                _context3.next = 15;\n                                break;\n                              }\n\n                              console.log(\"Image found\");\n                              canvas = imageDisplay.childNodes[0];\n\n                              if (!canvas.toBlob) {\n                                _context3.next = 12;\n                                break;\n                              }\n\n                              _context3.next = 10;\n                              return canvas.toBlob(\n                              /*#__PURE__*/\n                              function () {\n                                var _ref2 = _asyncToGenerator(\n                                /*#__PURE__*/\n                                regeneratorRuntime.mark(function _callee2(blob) {\n                                  var _imageDisplay, report, results;\n\n                                  return regeneratorRuntime.wrap(function _callee2$(_context2) {\n                                    while (1) {\n                                      switch (_context2.prev = _context2.next) {\n                                        case 0:\n                                          console.log(blob);\n                                          data.image = blob;\n                                          data.imageURL = document.querySelector('.js-issue-photo').value;\n                                          data.roadName = document.querySelector('.js-issue-roadName').value;\n                                          data.details = document.querySelector('.js-issue-details').value;\n                                          data.nearestStreet = document.querySelector('.js-issue-nearestStreet').value;\n                                          data.magistrialDistrict = document.querySelector('.js-issue-magistrialDistrict').value;\n\n                                          if (document.querySelector('.js-issue-priority-input-true').checked == true) {\n                                            data.priority = true;\n                                          } else {\n                                            data.priority = false;\n                                          }\n\n                                          if (!data.image) {\n                                            _context2.next = 24;\n                                            break;\n                                          }\n\n                                          // If all fields are filled, create a new report from data and save the report\n                                          _imageDisplay = document.querySelector('.js-form-img-display');\n                                          report = new _models_Report_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](data);\n                                          document.querySelector('.loading-overlay').classList.toggle('loading-overlay__is-visible');\n                                          if (_imageDisplay.hasChildNodes()) _imageDisplay.removeChild(_imageDisplay.childNodes[0]);\n                                          document.querySelector('.js-issue-photo').value = null;\n                                          document.querySelector('.js-issue-roadName').value = '';\n                                          document.querySelector('.js-issue-details').value = '';\n                                          document.querySelector('.js-issue-nearestStreet').value = '';\n                                          document.querySelector('.js-issue-magistrialDistrict').value = '';\n                                          _context2.next = 20;\n                                          return reportUploadFunction(report);\n\n                                        case 20:\n                                          results = _context2.sent;\n\n                                          if (results && results.error) {\n                                            document.querySelector('.loading-overlay').classList.toggle('loading-overlay__is-visible');\n                                            console.log(error);\n                                          } else if (results && results.result) {\n                                            document.querySelector('.loading-overlay').classList.toggle('loading-overlay__is-visible');\n                                          }\n\n                                          _context2.next = 25;\n                                          break;\n\n                                        case 24:\n                                          console.log(\"data.img not found\");\n\n                                        case 25:\n                                        case \"end\":\n                                          return _context2.stop();\n                                      }\n                                    }\n                                  }, _callee2);\n                                }));\n\n                                return function (_x4) {\n                                  return _ref2.apply(this, arguments);\n                                };\n                              }(), 'image/jpeg');\n\n                            case 10:\n                              _context3.next = 13;\n                              break;\n\n                            case 12:\n                              console.log(\"canvas to blob failed\");\n\n                            case 13:\n                              _context3.next = 16;\n                              break;\n\n                            case 15:\n                              console.log(\"Image was not found\");\n\n                            case 16:\n                            case \"end\":\n                              return _context3.stop();\n                          }\n                        }\n                      }, _callee3);\n                    }));\n\n                    return function (_x3) {\n                      return _ref.apply(this, arguments);\n                    };\n                  }());\n                } else {\n                  console.log(\"Could not find form\");\n                }\n\n              case 1:\n              case \"end\":\n                return _context4.stop();\n            }\n          }\n        }, _callee4, this);\n      }));\n\n      function initilizeReportDataForm(_x2) {\n        return _initilizeReportDataForm.apply(this, arguments);\n      }\n\n      return initilizeReportDataForm;\n    }()\n  }, {\n    key: \"initilizeSettingsForm\",\n    value: function () {\n      var _initilizeSettingsForm = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee6(notificationsOn, notificationsOff, saveDeviceToken) {\n        var settingsNotificationsTrue, settingsNotificationsFalse;\n        return regeneratorRuntime.wrap(function _callee6$(_context6) {\n          while (1) {\n            switch (_context6.prev = _context6.next) {\n              case 0:\n                if (this.settingsForm) {\n                  settingsNotificationsTrue = document.querySelector('.js-notiffication-input.true');\n                  settingsNotificationsFalse = document.querySelector('.js-notiffication-input.false'); // If the report form elements initilized properly, listen for user to submit the report\n\n                  this.settingsForm.addEventListener('submit',\n                  /*#__PURE__*/\n                  function () {\n                    var _ref3 = _asyncToGenerator(\n                    /*#__PURE__*/\n                    regeneratorRuntime.mark(function _callee5(event) {\n                      return regeneratorRuntime.wrap(function _callee5$(_context5) {\n                        while (1) {\n                          switch (_context5.prev = _context5.next) {\n                            case 0:\n                              event.preventDefault();\n                              event.stopPropagation();\n\n                              if (settingsNotificationsTrue.checked) {\n                                notificationsOn();\n                                saveDeviceToken();\n                              } else if (settingsNotificationsFalse.checked) {\n                                notificationsOff();\n                              }\n\n                            case 3:\n                            case \"end\":\n                              return _context5.stop();\n                          }\n                        }\n                      }, _callee5);\n                    }));\n\n                    return function (_x8) {\n                      return _ref3.apply(this, arguments);\n                    };\n                  }());\n                }\n\n              case 1:\n              case \"end\":\n                return _context6.stop();\n            }\n          }\n        }, _callee6, this);\n      }));\n\n      function initilizeSettingsForm(_x5, _x6, _x7) {\n        return _initilizeSettingsForm.apply(this, arguments);\n      }\n\n      return initilizeSettingsForm;\n    }() // Clear report form data\n\n  }, {\n    key: \"clearReportData\",\n    value: function clearReportData() {\n      this.reportImage.reset(), this.reportRoadName.value = '';\n      this.reportDetails.value = '';\n      this.reportNearestStreet.value = '';\n      this.reportMagistrialDistrict.value = '';\n    }\n    /**\n     * Admin DOM Functions\n     */\n    // Set variables for admin html listeners and load the users previously left list or reports-list my default\n\n  }, {\n    key: \"loadAdminHTML\",\n    value: function () {\n      var _loadAdminHTML = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee7() {\n        return regeneratorRuntime.wrap(function _callee7$(_context7) {\n          while (1) {\n            switch (_context7.prev = _context7.next) {\n              case 0:\n                this.adminPage.style.display = 'flex';\n                this.sidebarReports.style.display = 'flex';\n                this.sidebarReport.style.display = 'flex';\n                this.sidebarSettings.style.display = 'flex';\n                this.sidebarUsers.style.display = 'flex';\n                this.sidebarPendingUsers.style.display = 'flex';\n                this.sidebarLogin.style.display = 'none';\n                this.renderModeratorReportsList();\n\n              case 8:\n              case \"end\":\n                return _context7.stop();\n            }\n          }\n        }, _callee7, this);\n      }));\n\n      function loadAdminHTML() {\n        return _loadAdminHTML.apply(this, arguments);\n      }\n\n      return loadAdminHTML;\n    }() // Remove listeners for list and render the setting form\n\n  }, {\n    key: \"renderSettingsView\",\n    value: function renderSettingsView() {\n      this.reportsList.innerHTML = '';\n      this.verifiedUserPage.style.display = 'none';\n      this.adminPage.style.display = 'none';\n      this.settingsPage.style.display = 'flex';\n    } // Remove Listeners for other list and setup report list listener to render report list items\n\n  }, {\n    key: \"renderModeratorReportsList\",\n    value: function () {\n      var _renderModeratorReportsList = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee10() {\n        var _this2 = this;\n\n        var listener;\n        return regeneratorRuntime.wrap(function _callee10$(_context10) {\n          while (1) {\n            switch (_context10.prev = _context10.next) {\n              case 0:\n                this.verifiedUserPage.style.display = 'none';\n                this.settingsPage.style.display = 'none';\n                this.adminPage.style.display = 'flex';\n                this.reportsList.style.display = 'flex';\n                this.reportsList.innerHTML = '';\n                _context10.next = 7;\n                return this.listeners.forEach(function (listener) {\n                  return listener();\n                });\n\n              case 7:\n                _context10.next = 9;\n                return firebase.firestore().collection(\"reports\").onSnapshot(\n                /*#__PURE__*/\n                function () {\n                  var _ref4 = _asyncToGenerator(\n                  /*#__PURE__*/\n                  regeneratorRuntime.mark(function _callee9(snapshot) {\n                    var numberOfReports;\n                    return regeneratorRuntime.wrap(function _callee9$(_context9) {\n                      while (1) {\n                        switch (_context9.prev = _context9.next) {\n                          case 0:\n                            numberOfReports = 0;\n                            _context9.next = 3;\n                            return snapshot.docChanges().forEach(\n                            /*#__PURE__*/\n                            function () {\n                              var _ref5 = _asyncToGenerator(\n                              /*#__PURE__*/\n                              regeneratorRuntime.mark(function _callee8(change) {\n                                return regeneratorRuntime.wrap(function _callee8$(_context8) {\n                                  while (1) {\n                                    switch (_context8.prev = _context8.next) {\n                                      case 0:\n                                        numberOfReports += 1;\n                                        _context8.next = 3;\n                                        return _this2.checkChangeType(change, _this2.createModeratorReport, numberOfReports);\n\n                                      case 3:\n                                      case \"end\":\n                                        return _context8.stop();\n                                    }\n                                  }\n                                }, _callee8);\n                              }));\n\n                              return function (_x10) {\n                                return _ref5.apply(this, arguments);\n                              };\n                            }());\n\n                          case 3:\n                          case \"end\":\n                            return _context9.stop();\n                        }\n                      }\n                    }, _callee9);\n                  }));\n\n                  return function (_x9) {\n                    return _ref4.apply(this, arguments);\n                  };\n                }(), function (error) {\n                  console.log(error);\n                });\n\n              case 9:\n                listener = _context10.sent;\n                this.listeners.push(listener);\n\n              case 11:\n              case \"end\":\n                return _context10.stop();\n            }\n          }\n        }, _callee10, this);\n      }));\n\n      function renderModeratorReportsList() {\n        return _renderModeratorReportsList.apply(this, arguments);\n      }\n\n      return renderModeratorReportsList;\n    }()\n  }, {\n    key: \"renderVerifiedUserReportsList\",\n    value: function () {\n      var _renderVerifiedUserReportsList = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee13() {\n        var _this3 = this;\n\n        var listener;\n        return regeneratorRuntime.wrap(function _callee13$(_context13) {\n          while (1) {\n            switch (_context13.prev = _context13.next) {\n              case 0:\n                this.verifiedUserPage.style.display = 'none';\n                this.settingsPage.style.display = 'none';\n                this.adminPage.style.display = 'flex';\n                this.reportsList.style.display = 'flex';\n                this.reportsList.innerHTML = '';\n                _context13.next = 7;\n                return this.listeners.forEach(function (listener) {\n                  return listener();\n                });\n\n              case 7:\n                _context13.next = 9;\n                return firebase.firestore().collection(\"reports\").onSnapshot(\n                /*#__PURE__*/\n                function () {\n                  var _ref6 = _asyncToGenerator(\n                  /*#__PURE__*/\n                  regeneratorRuntime.mark(function _callee12(snapshot) {\n                    var numberOfReports;\n                    return regeneratorRuntime.wrap(function _callee12$(_context12) {\n                      while (1) {\n                        switch (_context12.prev = _context12.next) {\n                          case 0:\n                            numberOfReports = 0;\n                            _context12.next = 3;\n                            return snapshot.docChanges().forEach(\n                            /*#__PURE__*/\n                            function () {\n                              var _ref7 = _asyncToGenerator(\n                              /*#__PURE__*/\n                              regeneratorRuntime.mark(function _callee11(change) {\n                                return regeneratorRuntime.wrap(function _callee11$(_context11) {\n                                  while (1) {\n                                    switch (_context11.prev = _context11.next) {\n                                      case 0:\n                                        numberOfReports += 1;\n                                        _context11.next = 3;\n                                        return _this3.checkChangeType(change, _this3.createVerifiedUserReport, numberOfReports);\n\n                                      case 3:\n                                      case \"end\":\n                                        return _context11.stop();\n                                    }\n                                  }\n                                }, _callee11);\n                              }));\n\n                              return function (_x12) {\n                                return _ref7.apply(this, arguments);\n                              };\n                            }());\n\n                          case 3:\n                          case \"end\":\n                            return _context12.stop();\n                        }\n                      }\n                    }, _callee12);\n                  }));\n\n                  return function (_x11) {\n                    return _ref6.apply(this, arguments);\n                  };\n                }(), function (error) {\n                  console.log(error);\n                });\n\n              case 9:\n                listener = _context13.sent;\n                this.listeners.push(listener);\n\n              case 11:\n              case \"end\":\n                return _context13.stop();\n            }\n          }\n        }, _callee13, this);\n      }));\n\n      function renderVerifiedUserReportsList() {\n        return _renderVerifiedUserReportsList.apply(this, arguments);\n      }\n\n      return renderVerifiedUserReportsList;\n    }() // Create a report list item to be displayed\n\n  }, {\n    key: \"createModeratorReport\",\n    value: function createModeratorReport(data, id) {\n      return \"\\n            <div class=\\\"report-item js-report-item \".concat(id, \"\\\" data-id=\\\"\").concat(id, \"\\\">\\n                <figure class=\\\"report-item__figure\\\">\\n                <img class=\\\"report-item__img\\\" src=\\\"\").concat(data.imageUrl || \"images/Spin-1s-80px.svg\", \"\\\"/>\\n                </figure>\\n                <div class=\\\"report-item__data disable-scrollbars\\\">\\n                <h4><span class= report-item__subheader>Sender:</span> \").concat(data.sender, \"</h4>\\n                <p><span class= report-item__subheader>Date:</span> \").concat(data.timestamp, \"</p>\\n                <p><span class= report-item__subheader>Road Name:</span> \").concat(data.roadName, \"</p>\\n                <p><span class= report-item__subheader>Description:</span> \").concat(data.details, \"</p>\\n                <p><span class= report-item__subheader>Nearest Street:</span> \").concat(data.nearestStreet, \"</p>\\n                <p><span class= report-item__subheader>Magistrial District:</span> \").concat(data.magistrialDistrict, \"</p>\\n                </div>\\n                <button class=\\\"report-item__button report-item__button-delete .js-report-item-delete\\\" title=\\\"Delete\\\"></button>\\n                <button class=\\\"report-item__button report-item__button-print .js-report-item-print\\\" title=\\\"Print\\\"></button>\\n                <label class=\\\"report-item__button-prioritize .js-report-item-prioritize\\\" title=\\\"Prioritize\\\">\\n                    <input type=\\\"checkbox\\\" class=\\\"checkbox\\\" \").concat(data.priority ? \"checked\" : \"\", \">\\n                    <span class=\\\"checkmark\\\"></span>\\n                </label>\\n            </div>\");\n    }\n  }, {\n    key: \"createVerifiedUserReport\",\n    value: function createVerifiedUserReport(data, id) {\n      return \"\\n    <div class=\\\"report-item js-report-item \".concat(id, \"\\\" data-id=\\\"\").concat(id, \"\\\">\\n        <figure class=\\\"report-item__figure\\\">\\n        <img class=\\\"report-item__img\\\" src=\\\"\").concat(data.imageUrl || \"images/Spin-1s-80px.svg\", \"\\\"/>\\n        </figure>\\n        <div class=\\\"report-item__data disable-scrollbars\\\">\\n        <h4><span class= report-item__subheader>Sender:</span> \").concat(data.sender, \"</h4>\\n        <p><span class= report-item__subheader>Date:</span> \").concat(data.timestamp, \"</p>\\n        <p><span class= report-item__subheader>Road Name:</span> \").concat(data.roadName, \"</p>\\n        <p><span class= report-item__subheader>Description:</span> \").concat(data.details, \"</p>\\n        <p><span class= report-item__subheader>Nearest Street:</span> \").concat(data.nearestStreet, \"</p>\\n        <p><span class= report-item__subheader>Magistrial District:</span> \").concat(data.magistrialDistrict, \"</p>\\n        </div>\\n    </div>\");\n    }\n  }, {\n    key: \"toggleBorder\",\n    value: function toggleBorder(id) {\n      document.querySelector(\".\".concat(id)).classList.toggle(\"priority-border\");\n    } // Remove listeners for other list and setup users list listener to render user list items\n\n  }, {\n    key: \"renderUsersList\",\n    value: function () {\n      var _renderUsersList = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee16() {\n        var _this4 = this;\n\n        var listener;\n        return regeneratorRuntime.wrap(function _callee16$(_context16) {\n          while (1) {\n            switch (_context16.prev = _context16.next) {\n              case 0:\n                this.toggleLoadingOverlay();\n                this.verifiedUserPage.style.display = 'none';\n                this.settingsPage.style.display = 'none';\n                this.adminPage.style.display = 'flex';\n                this.reportsList.style.display = 'flex';\n                this.reportsList.innerHTML = '';\n                _context16.next = 8;\n                return this.listeners.forEach(function (listener) {\n                  return listener();\n                });\n\n              case 8:\n                _context16.next = 10;\n                return firebase.firestore().collection(\"users\").onSnapshot(\n                /*#__PURE__*/\n                function () {\n                  var _ref8 = _asyncToGenerator(\n                  /*#__PURE__*/\n                  regeneratorRuntime.mark(function _callee15(snapshot) {\n                    return regeneratorRuntime.wrap(function _callee15$(_context15) {\n                      while (1) {\n                        switch (_context15.prev = _context15.next) {\n                          case 0:\n                            _context15.next = 2;\n                            return snapshot.docChanges().forEach(\n                            /*#__PURE__*/\n                            function () {\n                              var _ref9 = _asyncToGenerator(\n                              /*#__PURE__*/\n                              regeneratorRuntime.mark(function _callee14(change) {\n                                return regeneratorRuntime.wrap(function _callee14$(_context14) {\n                                  while (1) {\n                                    switch (_context14.prev = _context14.next) {\n                                      case 0:\n                                        _context14.next = 2;\n                                        return _this4.checkChangeType(change, _this4.createUserCard);\n\n                                      case 2:\n                                      case \"end\":\n                                        return _context14.stop();\n                                    }\n                                  }\n                                }, _callee14);\n                              }));\n\n                              return function (_x14) {\n                                return _ref9.apply(this, arguments);\n                              };\n                            }());\n\n                          case 2:\n                          case \"end\":\n                            return _context15.stop();\n                        }\n                      }\n                    }, _callee15);\n                  }));\n\n                  return function (_x13) {\n                    return _ref8.apply(this, arguments);\n                  };\n                }(), function (error) {\n                  console.log(error);\n                });\n\n              case 10:\n                listener = _context16.sent;\n                this.listeners.push(listener);\n                this.toggleLoadingOverlay();\n\n              case 13:\n              case \"end\":\n                return _context16.stop();\n            }\n          }\n        }, _callee16, this);\n      }));\n\n      function renderUsersList() {\n        return _renderUsersList.apply(this, arguments);\n      }\n\n      return renderUsersList;\n    }() // Create a user list item to be displayed\n\n  }, {\n    key: \"createUserCard\",\n    value: function createUserCard(data) {\n      return \"\\n        <div class=\\\"user-list__item-container js-users-list__item\\\" data-email=\\\"\".concat(data.email, \"\\\">\\n         <div class=\\\"users-list__item top js-users-list__item\\\">\\n            <h4>\").concat(data.displayName, \"</h4>\\n         </div>\\n         <div class=\\\"options\\\">\\n            <div class=\\\"options-btn start js-moderate-btn\\\">Moderate</div>\\n            <div class=\\\"options-btn js-verify-btn\\\">Verifiy</div>\\n            <div class=\\\"options-btn end js-unverify-btn\\\">Unverify</div>\\n          </div>\\n          <div class=\\\"users-list__item bottom\\\"></div>\\n        </div>\");\n    } // Remove listeners for other list and setup pending users list listener to render pending users list items\n\n  }, {\n    key: \"renderPendingUsersList\",\n    value: function () {\n      var _renderPendingUsersList = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee19() {\n        var _this5 = this;\n\n        var listener;\n        return regeneratorRuntime.wrap(function _callee19$(_context19) {\n          while (1) {\n            switch (_context19.prev = _context19.next) {\n              case 0:\n                this.verifiedUserPage.style.display = 'none';\n                this.settingsPage.style.display = 'none';\n                this.adminPage.style.display = 'flex';\n                this.reportsList.style.display = 'flex';\n                this.reportsList.innerHTML = '';\n                _context19.next = 7;\n                return this.listeners.forEach(function (listener) {\n                  return listener();\n                });\n\n              case 7:\n                _context19.next = 9;\n                return firebase.firestore().collection('pendingUsers').onSnapshot(\n                /*#__PURE__*/\n                function () {\n                  var _ref10 = _asyncToGenerator(\n                  /*#__PURE__*/\n                  regeneratorRuntime.mark(function _callee18(snapshot) {\n                    return regeneratorRuntime.wrap(function _callee18$(_context18) {\n                      while (1) {\n                        switch (_context18.prev = _context18.next) {\n                          case 0:\n                            _context18.next = 2;\n                            return snapshot.docChanges().forEach(\n                            /*#__PURE__*/\n                            function () {\n                              var _ref11 = _asyncToGenerator(\n                              /*#__PURE__*/\n                              regeneratorRuntime.mark(function _callee17(change) {\n                                return regeneratorRuntime.wrap(function _callee17$(_context17) {\n                                  while (1) {\n                                    switch (_context17.prev = _context17.next) {\n                                      case 0:\n                                        _context17.next = 2;\n                                        return _this5.checkChangeType(change, _this5.createPenndingUserCard);\n\n                                      case 2:\n                                      case \"end\":\n                                        return _context17.stop();\n                                    }\n                                  }\n                                }, _callee17);\n                              }));\n\n                              return function (_x16) {\n                                return _ref11.apply(this, arguments);\n                              };\n                            }());\n\n                          case 2:\n                          case \"end\":\n                            return _context18.stop();\n                        }\n                      }\n                    }, _callee18);\n                  }));\n\n                  return function (_x15) {\n                    return _ref10.apply(this, arguments);\n                  };\n                }(), function (error) {\n                  console.log(error);\n                });\n\n              case 9:\n                listener = _context19.sent;\n                this.listeners.push(listener);\n\n              case 11:\n              case \"end\":\n                return _context19.stop();\n            }\n          }\n        }, _callee19, this);\n      }));\n\n      function renderPendingUsersList() {\n        return _renderPendingUsersList.apply(this, arguments);\n      }\n\n      return renderPendingUsersList;\n    }() // Creaate a pending user list item to be displayed\n\n  }, {\n    key: \"createPenndingUserCard\",\n    value: function createPenndingUserCard(data) {\n      return \"\\n            <div class=\\\"user-list__item-container js-pendingUsers-list__item\\\" data-email=\\\"\".concat(data.email, \"\\\">\\n                <div class=\\\"users-list__item top js-pendingUsers-list__item\\\" data-email=\\\"\").concat(data.email, \"\\\">\\n                    <h4>\").concat(data.displayName, \"</h4>\\n                </div>\\n                <div class=\\\"options\\\">\\n                    <div class=\\\"options-btn start js-moderate-btn\\\">Moderate</div>\\n                    <div class=\\\"options-btn js-verify-btn\\\">Verifiy</div>\\n                    <div class=\\\"options-btn end js-unverify-btn\\\">Unverify</div>\\n                </div>\\n                <div class=\\\"users-list__item bottom\\\" data-email=\\\"\").concat(data.email, \"\\\">\\n                </div>\\n            </div>\");\n    }\n  }, {\n    key: \"checkChangeType\",\n    // Check changes for list listeners above and render elements as needed\n    value: function checkChangeType(change, cardCreator) {\n      var _this6 = this;\n\n      if (change.type === \"added\") {\n        if (cardCreator == this.createModeratorReport && change.doc.data().priority == true) {\n          this.reportsList.insertAdjacentHTML('afterbegin', cardCreator(change.doc.data(), change.doc.id));\n          this.toggleBorder(change.doc.id);\n        } else if (cardCreator == this.createModeratorReport) {\n          this.reportsList.insertAdjacentHTML('beforeend', cardCreator(change.doc.data(), change.doc.id));\n        } else if (cardCreator == this.createVerifiedUserReport && change.doc.data().priority == true) {\n          this.reportsList.insertAdjacentHTML('afterbegin', cardCreator(change.doc.data(), change.doc.id));\n          this.toggleBorder(change.doc.id);\n        } else if (cardCreator == this.createVerifiedUserReport) {\n          this.reportsList.insertAdjacentHTML('beforeend', cardCreator(change.doc.data(), change.doc.id));\n        } else {\n          this.reportsList.insertAdjacentHTML('beforeend', cardCreator(change.doc.data()));\n        }\n      }\n\n      if (change.type === \"modified\") {\n        if (this.reportsList.hasChildNodes()) {\n          var array = Array.from(this.reportsList.children);\n          array.forEach(function (element) {\n            if (element.dataset.id === \"\".concat(change.doc.data().id)) {\n              var figure = element.querySelector('.report-item__figure');\n              figure.querySelector('.report-item__img').src = \"\".concat(change.doc.data().imageUrl);\n            }\n          });\n        }\n      }\n\n      if (change.type === \"removed\") {\n        if (this.reportsList.hasChildNodes()) {\n          var array = Array.from(this.reportsList.children);\n\n          if (cardCreator == this.createModeratorReport) {\n            array.forEach(function (element, index) {\n              if (element.dataset && element.dataset.id === \"\".concat(change.doc.data().id)) {\n                _this6.reportsList.removeChild(_this6.reportsList.children[index]);\n              }\n            });\n          } else {\n            array.forEach(function (element, index) {\n              if (element.dataset.email === \"\".concat(change.doc.data().email)) {\n                _this6.reportsList.removeChild(_this6.reportsList.children[index]);\n              }\n            });\n          }\n        }\n      }\n    }\n    /**\n     * Misc DOM Functions\n     */\n    // Display the onlife indicator\n\n  }, {\n    key: \"showOfflineIndicator\",\n    value: function showOfflineIndicator() {\n      this.offlineIndicator.style.display = 'flex';\n    } // Toggle the loading overlay html element\n\n  }, {\n    key: \"toggleLoadingOverlay\",\n    value: function toggleLoadingOverlay() {\n      document.querySelector('.loading-overlay').classList.toggle('loading-overlay__is-visible');\n    } // Remove download button and download web app locally\n\n  }, {\n    key: \"addToHomeScreen\",\n    value: function addToHomeScreen() {\n      var _this7 = this;\n\n      console.log(\"Download button clicked\");\n      this.deferredPrompt.prompt();\n      this.deferredPrompt.userChoice.then(function (choiceResult) {\n        if (choiceResult.outcome === 'accepted') {\n          console.log('User accepted the download prompt');\n        } else {\n          console.log('User dismissed the download prompt');\n        }\n\n        _this7.deferredPrompt = null;\n      });\n    }\n  }, {\n    key: \"reviealReportPrintPage\",\n    value: function reviealReportPrintPage(report) {\n      console.log(\"Showing report print page\");\n      this.reportPrintImg.src = \"\";\n      this.reportPrintSender.textContent = \"\";\n      this.reportPrintMagistrialDistrict.textContent = \"\";\n      this.reportPrintRoadName.textContent = \"\";\n      this.reportPrintNearestStreet.textContent = \"\";\n      this.reportPrintDate.textContent = \"\";\n      this.reportPrintImg.src = \"\".concat(report.imageURL);\n      this.reportPrintSender.textContent = \"Sender: \".concat(report.sender);\n      this.reportPrintMagistrialDistrict.textContent = \"Magistrial District: \".concat(report.magistrialDistrict);\n      this.reportPrintRoadName.textContent = \"Road Name: \".concat(report.roadName);\n      this.reportPrintNearestStreet.textContent = \"Nearest Street: \".concat(report.nearestStreet);\n      this.reportPrintDate.textContent = \"Date: \".concat(report.date);\n      window.print();\n      console.log(\"Printing Window\");\n    }\n  }]);\n\n  return Elements;\n}();\n\n\n\n//# sourceURL=webpack:///./src/scrips/base.js?");

/***/ }),

/***/ "./src/scrips/firestore.js":
/*!*********************************!*\
  !*** ./src/scrips/firestore.js ***!
  \*********************************/
/*! exports provided: checkSetup, signIn, isModerator, setupAuthUi, signOut, getUserName, getProfilePicUrl, grantModeratorRole, validateUser, unvalidateUser, saveReport, removeReportListItem, saveMessagingDeviceToken, updateMessagingDeviceToken, checkAllowNotifications, toggleNotificationsOn, toggleNotificationsOff, getReport, updatePriority */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"checkSetup\", function() { return checkSetup; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"signIn\", function() { return signIn; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"isModerator\", function() { return isModerator; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"setupAuthUi\", function() { return setupAuthUi; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"signOut\", function() { return signOut; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getUserName\", function() { return getUserName; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getProfilePicUrl\", function() { return getProfilePicUrl; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"grantModeratorRole\", function() { return grantModeratorRole; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"validateUser\", function() { return validateUser; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"unvalidateUser\", function() { return unvalidateUser; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"saveReport\", function() { return saveReport; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"removeReportListItem\", function() { return removeReportListItem; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"saveMessagingDeviceToken\", function() { return saveMessagingDeviceToken; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"updateMessagingDeviceToken\", function() { return updateMessagingDeviceToken; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"checkAllowNotifications\", function() { return checkAllowNotifications; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"toggleNotificationsOn\", function() { return toggleNotificationsOn; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"toggleNotificationsOff\", function() { return toggleNotificationsOff; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getReport\", function() { return getReport; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"updatePriority\", function() { return updatePriority; });\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n/**\n*  Firebase Javascrips Code\n*/\n// Check if firebase is setup properly\nfunction checkSetup() {\n  if (!window.firebase || !(firebase.app instanceof Function) || !firebase.app().options) {\n    window.alert('You have not configured and imported the Firebase SDK. ' + 'Make sure you go through the codelab setup instructions and make ' + 'sure you are running the codelab using `firebase serve`');\n  } else {\n    return true;\n  }\n} // Sign user into app\n\nfunction signIn() {\n  var provider = new firebase.auth.GoogleAuthProvider();\n  firebase.auth().signInWithRedirect(provider);\n}\nfunction isModerator() {\n  var checkModerator = firebase.functions().httpsCallable('checkModeratorToken');\n  return checkModerator({\n    email: email\n  }).then(function (results) {\n    if (results && results.data.error !== undefined) {\n      console.log(results.data);\n    } else {\n      return results.data.result;\n    }\n  });\n}\nfunction setupAuthUi() {\n  var ui = new firebaseui.auth.AuthUI(firebase.auth());\n  var uiConfig = {\n    callbacks: {\n      signInSuccessWithAuthResult: function signInSuccessWithAuthResult(authResult, redirectUrl) {\n        return true;\n      },\n      uiShown: function uiShown() {}\n    },\n    signInFlow: 'popup',\n    signInOptions: [{\n      provider: firebase.auth.GoogleAuthProvider.PROVIDER_ID,\n      prompt: 'select_account'\n    }, {\n      provider: firebase.auth.EmailAuthProvider.PROVIDER_ID,\n      requireDisplayName: true\n    }]\n  };\n  ui.start('.firebaseui-auth-container', uiConfig);\n} // Sign user our of app\n\nfunction signOut() {\n  firebase.auth().signOut();\n} // Get current users display name\n\nfunction getUserName() {\n  return firebase.auth().currentUser.displayName;\n} // Get current user display img\n\nfunction getProfilePicUrl() {\n  return firebase.auth().currentUser.photoURL || '/images/profile_image_dummy.svg';\n} // Moderate user from firebase functions\n\nfunction grantModeratorRole(email) {\n  var addAdmin = firebase.functions().httpsCallable('addAdmin');\n  addAdmin({\n    email: email\n  }).then(function (results) {\n    if (results && results.data.error !== undefined) {\n      console.log(results.data);\n    } else {\n      console.log(results.data.result);\n    }\n  });\n} // Validate user from firebase functions\n\nfunction validateUser(_x) {\n  return _validateUser.apply(this, arguments);\n} // Unvalidate user from firebase functions\n\nfunction _validateUser() {\n  _validateUser = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee(email) {\n    var addUser;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.next = 2;\n            return firebase.functions().httpsCallable('addUser');\n\n          case 2:\n            addUser = _context.sent;\n            _context.next = 5;\n            return addUser({\n              email: email\n            }).then(function (results) {\n              if (results && results.data && results.data.error) {\n                console.log(results.data);\n              } else if (results && results.data && results.data.result) {\n                console.log(results.data.result);\n              }\n            });\n\n          case 5:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n  return _validateUser.apply(this, arguments);\n}\n\nfunction unvalidateUser(_x2) {\n  return _unvalidateUser.apply(this, arguments);\n} // Save report data to firestore and storage\n\nfunction _unvalidateUser() {\n  _unvalidateUser = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee2(email) {\n    var removeUser;\n    return regeneratorRuntime.wrap(function _callee2$(_context2) {\n      while (1) {\n        switch (_context2.prev = _context2.next) {\n          case 0:\n            _context2.next = 2;\n            return firebase.functions().httpsCallable('removeUser');\n\n          case 2:\n            removeUser = _context2.sent;\n            _context2.next = 5;\n            return removeUser({\n              email: email\n            }).then(function (results) {\n              if (results && results.data && results.data.error) {\n                console.log(results.data);\n              } else if (results && results.data && results.data.result) {\n                console.log(results.data.result);\n              }\n            });\n\n          case 5:\n          case \"end\":\n            return _context2.stop();\n        }\n      }\n    }, _callee2);\n  }));\n  return _unvalidateUser.apply(this, arguments);\n}\n\nfunction saveReport(_x3) {\n  return _saveReport.apply(this, arguments);\n} // Remove report item and image\n\nfunction _saveReport() {\n  _saveReport = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee3(report) {\n    var date, readableDate;\n    return regeneratorRuntime.wrap(function _callee3$(_context3) {\n      while (1) {\n        switch (_context3.prev = _context3.next) {\n          case 0:\n            // Create and format the current date \n            date = new Date();\n            readableDate = date.toDateString(); // Add a report with a loading image that then gets replaced with the real image.\n\n            return _context3.abrupt(\"return\", firebase.firestore().collection(\"reports\").add({\n              sender: firebase.auth().currentUser.displayName,\n              timestamp: readableDate,\n              roadName: report.roadName,\n              details: report.details,\n              nearestStreet: report.nearestStreet,\n              magistrialDistrict: report.magistrialDistrict,\n              priority: report.priority\n            }).then(function (messageRef) {\n              // Upload the image to Cloud Storage\n              var filePath = 'reports/' + messageRef.id;\n              return firebase.storage().ref(filePath).put(report.image).then(function (fileSnapshot) {\n                // Generate a public URL for the file\n                return fileSnapshot.ref.getDownloadURL().then(function (url) {\n                  // Update the chat message placeholder with the real image\n                  return messageRef.update({\n                    id: messageRef.id,\n                    imageUrl: url,\n                    imageUri: fileSnapshot.metadata.fullPath\n                  }).then(function () {\n                    console.log(\"New Report was added.\");\n                    return {\n                      result: true\n                    };\n                  })[\"catch\"](function (err) {\n                    return {\n                      error: err\n                    };\n                  });\n                })[\"catch\"](function (err) {\n                  return {\n                    error: err\n                  };\n                });\n              })[\"catch\"](function (err) {\n                return {\n                  error: err\n                };\n              });\n            })[\"catch\"](function (err) {\n              return {\n                error: err\n              };\n            }));\n\n          case 3:\n          case \"end\":\n            return _context3.stop();\n        }\n      }\n    }, _callee3);\n  }));\n  return _saveReport.apply(this, arguments);\n}\n\nfunction removeReportListItem(id) {\n  firebase.firestore().collection('reports').doc(\"\".concat(id))[\"delete\"]().then(function () {\n    firebase.storage().ref('reports').child(\"\".concat(id))[\"delete\"]().then(function () {\n      console.log(\"Report was successfully removed\");\n    })[\"catch\"](function (err) {\n      console.log(err);\n    });\n  })[\"catch\"](function (err) {\n    console.log(err);\n  });\n} // Saves the messaging device token to the datastore.\n\nfunction saveMessagingDeviceToken() {\n  return _saveMessagingDeviceToken.apply(this, arguments);\n}\n\nfunction _saveMessagingDeviceToken() {\n  _saveMessagingDeviceToken = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee5() {\n    return regeneratorRuntime.wrap(function _callee5$(_context5) {\n      while (1) {\n        switch (_context5.prev = _context5.next) {\n          case 0:\n            firebase.messaging().getToken().then(\n            /*#__PURE__*/\n            function () {\n              var _ref = _asyncToGenerator(\n              /*#__PURE__*/\n              regeneratorRuntime.mark(function _callee4(currentToken) {\n                var saveDeviceToken;\n                return regeneratorRuntime.wrap(function _callee4$(_context4) {\n                  while (1) {\n                    switch (_context4.prev = _context4.next) {\n                      case 0:\n                        if (!currentToken) {\n                          _context4.next = 8;\n                          break;\n                        }\n\n                        console.log('Got FCM device token:', currentToken); // Saving the Device Token to the datastore.\n\n                        _context4.next = 4;\n                        return firebase.functions().httpsCallable('saveDeviceToken');\n\n                      case 4:\n                        saveDeviceToken = _context4.sent;\n                        return _context4.abrupt(\"return\", saveDeviceToken({\n                          token: currentToken\n                        }).then(function (results) {\n                          if (results.error) {\n                            console.log(results.error);\n                          }\n                        }));\n\n                      case 8:\n                        // Need to request permissions to show notifications.\n                        requestNotificationsPermissions();\n\n                      case 9:\n                      case \"end\":\n                        return _context4.stop();\n                    }\n                  }\n                }, _callee4);\n              }));\n\n              return function (_x4) {\n                return _ref.apply(this, arguments);\n              };\n            }())[\"catch\"](function (error) {\n              console.error('Unable to get messaging token.', error);\n            });\n\n          case 1:\n          case \"end\":\n            return _context5.stop();\n        }\n      }\n    }, _callee5);\n  }));\n  return _saveMessagingDeviceToken.apply(this, arguments);\n}\n\nfunction updateMessagingDeviceToken() {\n  firebase.messaging().onTokenRefresh(function () {\n    saveMessagingDeviceToken();\n  });\n}\n; // Requests permission to show notifications.\n\nfunction requestNotificationsPermissions() {\n  console.log('Requesting notifications permission...');\n  firebase.messaging().requestPermission().then(function () {\n    // Notification permission granted.\n    saveMessagingDeviceToken();\n  })[\"catch\"](function (error) {\n    console.error('Unable to get permission to notify.', error);\n  });\n}\n\nfunction checkAllowNotifications() {\n  return _checkAllowNotifications.apply(this, arguments);\n}\n\nfunction _checkAllowNotifications() {\n  _checkAllowNotifications = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee6() {\n    return regeneratorRuntime.wrap(function _callee6$(_context6) {\n      while (1) {\n        switch (_context6.prev = _context6.next) {\n          case 0:\n            firebase.functions().httpsCallable('checkAllowNotifications')().then(function (results) {\n              console.log(results);\n\n              if (results.data.error) {\n                console.log(results.data.error);\n              } else {\n                console.log(results.data.result);\n                return results.data.result;\n              }\n            });\n\n          case 1:\n          case \"end\":\n            return _context6.stop();\n        }\n      }\n    }, _callee6);\n  }));\n  return _checkAllowNotifications.apply(this, arguments);\n}\n\nfunction toggleNotificationsOn() {\n  return _toggleNotificationsOn.apply(this, arguments);\n}\n\nfunction _toggleNotificationsOn() {\n  _toggleNotificationsOn = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee7() {\n    var toggleNotifOn;\n    return regeneratorRuntime.wrap(function _callee7$(_context7) {\n      while (1) {\n        switch (_context7.prev = _context7.next) {\n          case 0:\n            _context7.next = 2;\n            return firebase.functions().httpsCallable('toggleNotificationsOn');\n\n          case 2:\n            toggleNotifOn = _context7.sent;\n            _context7.next = 5;\n            return toggleNotifOn().then(function (results) {\n              if (results.error) {\n                console.log(results.error);\n              } else {\n                console.log(results);\n              }\n            });\n\n          case 5:\n          case \"end\":\n            return _context7.stop();\n        }\n      }\n    }, _callee7);\n  }));\n  return _toggleNotificationsOn.apply(this, arguments);\n}\n\nfunction toggleNotificationsOff() {\n  return _toggleNotificationsOff.apply(this, arguments);\n}\n\nfunction _toggleNotificationsOff() {\n  _toggleNotificationsOff = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee8() {\n    var toggleNotifOff;\n    return regeneratorRuntime.wrap(function _callee8$(_context8) {\n      while (1) {\n        switch (_context8.prev = _context8.next) {\n          case 0:\n            _context8.next = 2;\n            return firebase.functions().httpsCallable('toggleNotificationsOff');\n\n          case 2:\n            toggleNotifOff = _context8.sent;\n            toggleNotifOff().then(function (results) {\n              if (results.error) {\n                console.log(results.error);\n              } else {\n                console.log(results);\n              }\n            });\n\n          case 4:\n          case \"end\":\n            return _context8.stop();\n        }\n      }\n    }, _callee8);\n  }));\n  return _toggleNotificationsOff.apply(this, arguments);\n}\n\nfunction getReport(id) {\n  return firebase.firestore().collection('reports').doc(id).get().then(function (doc) {\n    if (doc.exists) {\n      return doc.data();\n    } else {\n      console.log(\"Report with the ID \".concat(id, \" does not exists\"));\n      return false;\n    }\n  });\n} //Allow only moderators to change priority\n\nfunction updatePriority(id, value) {\n  firebase.firestore().collection('reports').doc(id).update({\n    priority: value\n  }).then(function () {})[\"catch\"](function (err) {\n    console.log(\"Priority was not able to be changed\");\n  });\n}\n\n//# sourceURL=webpack:///./src/scrips/firestore.js?");

/***/ }),

/***/ "./src/scrips/models/Report.js":
/*!*************************************!*\
  !*** ./src/scrips/models/Report.js ***!
  \*************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Report; });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Report = function Report(data) {\n  var date = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;\n\n  _classCallCheck(this, Report);\n\n  this.sender = data.sender;\n  this.image = data.image, this.imageURL = data.imageUrl, this.roadName = data.roadName, this.details = data.details, this.nearestStreet = data.nearestStreet, this.magistrialDistrict = data.magistrialDistrict, this.priority = data.priority;\n  this.date = date;\n};\n\n\n\n//# sourceURL=webpack:///./src/scrips/models/Report.js?");

/***/ }),

/***/ 0:
/*!************************************************!*\
  !*** multi babel-polyfill ./src/scrips/app.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! babel-polyfill */\"./node_modules/babel-polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! ./src/scrips/app.js */\"./src/scrips/app.js\");\n\n\n//# sourceURL=webpack:///multi_babel-polyfill_./src/scrips/app.js?");
